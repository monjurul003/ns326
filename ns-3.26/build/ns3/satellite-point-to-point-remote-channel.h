...
#ifndef SATELLITE_POINT_TO_POINT_REMOTE_CHANNEL_H
#define SATELLITE_POINT_TO_POINT_REMOTE_CHANNEL_H
 ...
 * method and uses an MPI Send operation instead.
 */
class SatellitePointToPointRemoteChannel : public SatellitePointToPointChannel
{
public:
  /**
   ...
   * \brief Constructor
   */
  SatellitePointToPointRemoteChannel ();
   ...
   */
  virtual bool TransmitStart (Ptr<Packet> p, Ptr<SatellitePointToPointNetDevice> src,
                              Time txTime);
};
