...
#ifndef SATELLITE_POINT_TO_POINT_NET_DEVICE_H
#define SATELLITE_POINT_TO_POINT_NET_DEVICE_H
 ...
 *
 * This SatellitePointToPointNetDevice class specializes the NetDevice abstract
 * base class.  Together with a SatellitePointToPointChannel (and a peer
 * SatellitePointToPointNetDevice), the class models, with some level of
 ...
 * propagation delay is set in the SatellitePointToPointChannel).
 */
class SatellitePointToPointNetDevice: public NetDevice
{
public:
	/**
	...
	/**
	 * Construct a SatellitePointToPointNetDevice
	 *
	 * This is the constructor for the SatellitePointToPointNetDevice.  It takes as a
	 * parameter a pointer to the Node to which this device is connected,
	 * as well as an optional DataRate object.
	 */
	SatellitePointToPointNetDevice();

	/**
	 * Destroy a SatellitePointToPointNetDevice
	 *
	 * This is the destructor for the SatellitePointToPointNetDevice.
	 */
	virtual ~SatellitePointToPointNetDevice();
	...
	void SetDataRate(DataRate bps);
        ...
        /**
	 * Get DataRate of the device.
	 *
	 * \returns DataRate of the device.
	 */
	 ...
	 */
	bool Attach(Ptr<SatellitePointToPointChannel> ch);

	/**
	 * Attach a queue to the SatellitePointToPointNetDevice.
	 *
	 * The SatellitePointToPointNetDevice "owns" a queue that implements a queueing
	...
	/**
	 * Attach a receive ErrorModel to the SatellitePointToPointNetDevice.
	 *
	 * The SatellitePointToPointNetDevice may optionally include an ErrorModel in
	...
	/**
	 * Receive a packet from a connected SatellitePointToPointChannel.
	 *
	 * The SatellitePointToPointNetDevice receives packets from its connected channel
	 ...
	 * \param p Ptr to the received packet.
	 */
	void ReceivePkt(Ptr<Packet> packet, double rxPower);
	...
	virtual bool SupportsSendFrom(void) const;
        ...
        void SetPhysical(Ptr<SatellitePhysical> obj);
        Ptr<SatellitePhysical> GetPhysical(void);
        
        double GetMdsValue(void);
protected:
	/**
...
private:
	 ...
	 */
	SatellitePointToPointNetDevice& operator =(
			const SatellitePointToPointNetDevice &o);
	 ...
	 * \param o Other NetDevice
	 */
	SatellitePointToPointNetDevice(const SatellitePointToPointNetDevice &o);
...
private:
	 ...
	 * SatellitePointToPointNetDevice to begin the process of sending a packet out on
	 * the channel.  The corresponding method is called on the channel to let
	 * it know that the physical device this class represents has virtually
	 * started sending signals.  An event is scheduled for the time at which
	 * the bits have been completely transmitted.
	 *
	 * \see SatellitePointToPointChannel::TransmitStart ()
	...
	/**
	 * The SatellitePointToPointChannel to which this SatellitePointToPointNetDevice has been
	 * attached.
	 */
	Ptr<SatellitePointToPointChannel> m_channel;
        
        /**
	 * The SatellitePhysical attached with SatellitePointToPointNetDevice
	 */
	Ptr<SatellitePhysical> m_physical;
        
        /**
         Minimum Detectable Signal(MDS) The rx signal should be greater than Noise floor 
         * otherwise it can not be detected. Noise floor is depent on the noise figure, bandwidth and temperature. 
         * NoiseFloor = NoiseFigure + 10* log(kT_s*1000) + 10 * log(B) (dBm)
         * Basically Noise floor comes -92 dBm we choose signal should be 10 times stronger than that so MDS = -82 dBm 
         */
        double m_mdsValue;
        

	/**
	 * The Queue which this SatellitePointToPointNetDevice uses as a packet source.
	 * Management of this Queue has been delegated to the SatellitePointToPointNetDevice
...
#endif /* SATELLITE_POINT_TO_POINT_NET_DEVICE_H */
